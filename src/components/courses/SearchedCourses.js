...
function SearchedCourses() {
  ...
  useEffect(() => {
    try {
      axios.get(baseUrl + "/searched_courses/" + searched_string).then((res) => {
      ...
      <div className="container-xxl py-5">
        ...
        <div className="container">
          <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
            ...
            <h1 className="m-2 ">Results for: <span className="text-success fw-bold"><i>{searched_string}</i></span></h1>
          </div>
